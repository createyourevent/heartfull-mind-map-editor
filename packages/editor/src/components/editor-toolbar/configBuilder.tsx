...
import HtmlIcon from '../../../images/forms/html.svg';
import FormIcon from '../../../images/forms/form.svg';
import TabsIcon from '../../../images/forms/tabs.svg';
import PageIcon from '../../../images/forms/page.svg';
import FieldsetIcon from '../../../images/forms/fieldset.svg';

import ControlsIcon from '../../../images/controls/controls.svg';
import TextfieldIcon from '../../../images/controls/textfield.svg';
import TextareaIcon from '../../../images/controls/textarea.svg';
...
export function buildEditorPanelConfig(model: Editor, intl: IntlShape): ActionConfig[] {
  ...
  const formsConfiguration: ActionConfig = {
    ...
    tooltip: intl.formatMessage({
      id: 'editor-panel.tooltip-html-form-elements',
    ...
    options: [
      {
        ...
        tooltip: intl.formatMessage({
          id: 'editor-panel.tooltip-topic-add-page',
      ...
      },
      {
        ...
        tooltip: intl.formatMessage({
          id: 'editor-panel.tooltip-topic-add-form',
      ...
      {
        icon: <img src={FieldsetIcon} />,
        tooltip: intl.formatMessage({
          id: 'editor-panel.tooltip-topic-add-fieldset',
      ...
      {
        icon: <img src={TabsIcon} />,
        tooltip: intl.formatMessage({
          id: 'editor-panel.tooltip-topic-add-tabs-menu',
  ...
  const controlsConfiguration: ActionConfig = {
    ...
    options: [
      {
        icon: <img src={TextfieldIcon} />,
        tooltip: intl.formatMessage({
          id: 'editor-panel.tooltip-add-textfield',
      ...
      },
      {
        ...
        tooltip: intl.formatMessage({
          id: 'editor-panel.tooltip-add-textarea',
      ...
      },
      {
        ...
        tooltip: intl.formatMessage({
          id: 'editor-panel.tooltip-add-checkbox',
      ...
      },
      {
        ...
        tooltip: intl.formatMessage({
          id: 'editor-panel.tooltip-add-radio',
      ...
      {
        icon: <img src={SelectIcon} />,
        tooltip: intl.formatMessage({
          id: 'editor-panel.tooltip-add-select',
      ...
      },
      {
        ...
        tooltip: intl.formatMessage({
          id: 'editor-panel.tooltip-add-editor',
      ...
      },
      {
        ...
        tooltip: intl.formatMessage({
          id: 'editor-panel.tooltip-add-address',
      ...
      {
        icon: <img src={ChipsIcon} />,
        tooltip: intl.formatMessage({
          id: 'editor-panel.tooltip-add-chips',
      ...
      {
        icon: <img src={MulticheckboxIcon} />,
        tooltip: intl.formatMessage({
          id: 'editor-panel.tooltip-add-multicheckbox',
      ...
      {
        icon: <img src={RatingsIcon} />,
        tooltip: intl.formatMessage({
          id: 'editor-panel.tooltip-add-ratings',
      ...
      },
      {
        ...
        tooltip: intl.formatMessage({
          id: 'editor-panel.tooltip-add-time',
